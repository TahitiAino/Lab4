...
if option == "Uber pickups in NYC":
    ...
    components.iframe("https://blogs.mathworks.com/images/loren/2016/uberNYC_05.png", height=800, width=800)
    ...
    components.iframe("https://www.researchgate.net/profile/Paolo-Braca/publication/344219122/figure/fig2/AS:935347378733058@1600015601593/Total-number-of-flights-tracked-by-FlightRadar24-from-January-to-July-20206-At-the-end.png", height=800, width=800)
